...
from models.multi_forward_tacotron import SeriesPredictor, MultiForwardTacotron, PosPredictor
...
if __name__ == '__main__':
    ...
    model = PosPredictor(num_chars=len(phonemes))

    #checkpoint = torch.load('/Users/cschaefe/workspace/ForwardTacotron/checkpoints/posgan_tts.forward/pos_latest_model.pt', map_location=torch.device('cpu'))
    #model.load_state_dict(checkpoint)
    save_path = paths.forward_checkpoints / 'pos_latest_model.pt'
