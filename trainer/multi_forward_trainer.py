...
class MultiForwardTrainer:
    ...
    def train_session(self,  model: Union[MultiForwardTacotron, MultiFastPitch],
        ...
        for e in range(1, epochs + 1):
            for i, batch in enumerate(session.train_set, 1):
                ...
                hub_loss = self.l1_loss(pred['hub_hat'].transpose(1, 2), batch['hub'], batch['x_len'])
                ...
                loss = m1_loss + m2_loss \
                       ...
                       + self.train_cfg['pitch_cond_loss_factor'] * pitch_cond_loss + hub_loss
    ...
    def evaluate(self, model: Union[MultiForwardTacotron, MultiFastPitch], val_set: DataLoader) -> Dict[str, float]:
        model.eval()
        val_losses = {
            'mel_loss': 0, 'dur_loss': 0, 'pitch_loss': 0, 'hub_loss': 0,
