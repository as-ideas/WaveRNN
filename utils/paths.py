...
class Paths:
    ...
    def __init__(self, data_path, tts_id):
        ...
        self.att_pred = self.data/'att_masked'
        self.alg = self.data/'alg_masked'
        self.speaker_emb = self.data/'speaker_emb'
        self.mean_speaker_emb = self.data/'mean_speaker_emb'
        self.raw_pitch = self.data/'raw_pitch'
        self.phon_pitch = self.data/'phon_pitch_masked'
        self.phon_energy = self.data/'phon_energy_masked'
