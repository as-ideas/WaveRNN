...
class Paths:
    ...
    def __init__(self, data_path, tts_id):
        ...
        self.att_pred = self.data/'att_pred_hubert'
        self.alg = self.data/'alg_hubert'
        self.speaker_emb = self.data/'speaker_emb'
        self.mean_speaker_emb = self.data/'mean_speaker_emb'
        self.raw_pitch = self.data/'raw_pitch'
        self.phon_pitch = self.data/'phon_pitch_hubert'
        self.phon_energy = self.data/'phon_energy_hubert'
