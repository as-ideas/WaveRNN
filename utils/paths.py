...
class Paths:
    ...
    def __init__(self, data_path, tts_id):
        ...
        self.alg = self.data/'alg_one_alignment'
        self.pitch_cwt = self.data/'pitch_cwt'
        self.alg_cwt = self.data/'alg_cwt'
        self.speaker_emb = self.data/'speaker_emb'
        self.mean_speaker_emb = self.data/'mean_speaker_emb'
        self.raw_pitch = self.data/'raw_pitch'
        self.phon_pitch = self.data/'phon_pitch_one_aligment'
        self.phon_energy = self.data/'phon_energy_one_aligne t'
